...
class Store(object):
    ...
    def save_to_mongo(self):
        Database.update(StoreConstants.COLLECTION, {'_id': self.id},self.json())
    ...
    def find_by_url(cls, url):
        for i in range(0, len(url)):
            try:
                ...
                raise StoreErrors.StoreNotFoundException("The Url Prefix used to find the store did not work")
